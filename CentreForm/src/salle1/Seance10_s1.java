...
public class Seance10_s1 extends JFrame {
	...
	private JList<String> list;
		...
		private JPanel createRightPanel() {
			...
			lblNewLabel_1.setBounds(120, 165, 130, 15);
		...
		public String nomMatiere() {
			String sql = "select NomMatiere from matieres where salle='salle1' and date='Vendredi' and horaire='13h à 16h'";
		...
		public String nomProf() {
			String sql = "select NomProf, PrenomProf from professeurs where NomMatiere in (select NomMatiere from matieres where salle='salle1' and date='Vendredi' and horaire='13h à 16h')";
		...
		public void listeEtudiants() {
			...
			String sql = "select NomEtud, PrenomEtud from etudiants where NomMatiere in (select NomMatiere from matieres where salle='salle1' and date='Vendredi' and horaire='13h à 16h')";
		...
		public static void main(String[] args) throws Exception {
			  ...
			  Seance10_s1 frame = new Seance10_s1();
