...
public class Seance8_s2 extends JFrame {
	...
	private JList<String> list;
		...
		public String nomMatiere() {
			String sql = "select NomMatiere from matieres where salle='salle2' and date='Jeudi' and horaire='13h à 16h'";
		...
		public String nomProf() {
			String sql = "select NomProf, PrenomProf from professeurs where NomMatiere in (select NomMatiere from matieres where salle='salle2' and date='Jeudi' and horaire='13h à 16h')";
		...
		public void listeEtudiants() {
			...
			String sql = "select NomEtud, PrenomEtud from etudiants where NomMatiere in (select NomMatiere from matieres where salle='salle2' and date='Jeudi' and horaire='13h à 16h')";
