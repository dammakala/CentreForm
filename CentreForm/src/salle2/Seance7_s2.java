...
public class Seance7_s2 extends JFrame {
	...
	private JList<String> list;
		...
		public String nomMatiere() {
			String sql = "select NomMatiere from matieres where salle='salle2' and date='Jeudi' and horaire='8h à 12h'";
		...
		public String nomProf() {
			String sql = "select NomProf, PrenomProf from professeurs where NomMatiere in (select NomMatiere from matieres where salle='salle2' and date='Jeudi' and horaire='8h à 12h')";
		...
		public void listeEtudiants() {
			...
			String sql = "select NomEtud, PrenomEtud from etudiants where NomMatiere in (select NomMatiere from matieres where salle='salle2' and date='Jeudi' and horaire='8h à 12h')";
		...
		public static void main(String[] args) throws Exception {
			  ...
			  Seance7_s2 frame = new Seance7_s2();
